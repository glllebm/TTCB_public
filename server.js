...
app.use("/api", async (req, res) => {
  try {
    // req.url is already relative to the "/api" mount point (e.g. "/players/123?x=1"),
...
// ---- Home page ----
// Assumption: "TTCB_Rating.html" is the intended landing page (its nav tab is marked
// active by default in the markup). Change the filename below if that's wrong.
app.get("/", (req, res) => {
